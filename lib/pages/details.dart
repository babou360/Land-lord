...
class Details extends StatefulWidget {
   ...
   Details({Key key, this.posts}) : super(key: key);
  @override
...
class _DetailsState extends State<Details> {
  ...
  void initState() {
    ...
    save() async{
     ...
     final userId=user.uid;
      ...
      .document(userId)
      .collection('userCart')
      .document(widget.posts.documentID)
      .setData({
        'postId':widget.posts.documentID,
        'email':widget.posts.data['email'],
        'phone':widget.posts.data['phone'],
        'region':widget.posts.data['region'],
        'descrption':widget.posts.data['descrption'],
        'authorId':widget.posts.data['authorId'],
        'addedAt':Timestamp.fromDate(DateTime.now()),
        'timestamp': widget.posts.data['timestamp'],
        'price': widget.posts.data['price'],
        'currency': widget.posts.data['currency'],
        'purpose': widget.posts.data['purpose'],
        'name':widget.posts.data['name'],
        'category':widget.posts.data['category'],
        'code':widget.posts.data['code'],
        'imageUrls':widget.posts.data['imageUrls'],
      });
      setState(() {
        saved=true;
      });
  ...
  navigatetoImages(){
   ...
   _isSaved() async{
     ...
     FirebaseUser user=await auth.currentUser();
     final userId=user.uid;
     bool isSavedPost=await DatabaseService.isSaved(userId,widget.posts.documentID);
     setState(() {
       saved=isSavedPost;
     });
   }
  ...
  Widget build(BuildContext context) {
    List list =widget.posts.data['imageUrls'];
    String phone=widget.posts.data['phone'];
    String code=widget.posts.data['code'];
    String mail=widget.posts.data['email'];
                    ...
                    children: [
                      ...
                      child: Row(
                        children: [
                          ...
                          //     tween: Tween<double>(begin: 0.5, end: 2.5),
                          ...
                          //       //        })
                          //       //     });
                          //       //     print(widget.posts.data['addedAt']);
                          //     })
                          //   ),
                          // ):Container(
                          ...
                          //       .document(widget.posts.documentID)
                          //       .setData({
                          //         'randomId':random.nextInt(1000).toString(), 
                          //         'authorId':widget.posts.data['authorId'],
                          //         'carter': userId,
                          //         'timestamp': widget.posts.data['timestamp'],
                          //         'price': widget.posts.data['price'],
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: Text(widget.posts.data['descrption'],
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                Container(
                                width: MediaQuery.of(context).size.width*0.5,
                               child: Text(widget.posts.data['category'],maxLines: 20,
                            ...
                            Container(
                               ...
                               child: Row(
                                 children: [
                                  ...
                                  Text(widget.posts.data['region'],maxLines: 20,
                                 style: TextStyle(color: Color(0xFF80E1D1),fontSize: 20,fontWeight: FontWeight.w500)),
                                 ],
                               ), 
                          ),
                            ...
                            Container(
                               ...
                               child: Row(
                                 children: [
                                  ...
                                  Text(widget.posts.data['price'],maxLines: 20,
                                 style: TextStyle(color: Color(0xFF80E1D1),fontSize: 20,fontWeight: FontWeight.w500)),
                                 SizedBox(width: 3,),
                                 Text(widget.posts.data['currency'],
                                 style: TextStyle(color: Color(0xFF80E1D1),fontSize: 20,fontWeight: FontWeight.w500))
                                 ],
                               ), 
                          ),
                            ...
                            Container(
                               ...
                               child: Row(
                                 children: [
                                  ...
                                  Text(widget.posts.data['purpose'],maxLines: 20,
                                 style: TextStyle(color: Color(0xFF80E1D1),fontSize: 20,fontWeight: FontWeight.w500)),
                                 ],
                               ), 
                          ),
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Container(
                               ...
                               child: Row(
                                 children: [
                                  Text(DateFormat.yMMMMd().add_jm().format(widget.posts.data['timestamp'].toDate()),maxLines: 20,
